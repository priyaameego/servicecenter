...
function BlogPostPage() {
  ...
  return (
    <div className="bg-white">
      ...
      <PageHero
        title={post.title}
        image={post.image || 'https://images.unsplash.com/photo-1581092335397-9583eb92d232?q=80&w=2000&auto=format&fit=crop'}
        height="md"
        breadcrumbs={[
          { label: 'Home', to: '/' },
          { label: 'Blog', to: '/blog' },
          { label: post.title.length > 25 ? post.title.slice(0, 25) + '…' : post.title },
        ]}
      />
        ...
        <div className="container-custom max-w-7xl">
          <div className="flex flex-col lg:flex-row gap-16">
            ...
            <div className="w-full lg:w-2/3 reveal">
              ...
              <h1 
                className="text-3xl md:text-4xl font-bold mb-6 text-[#111111] leading-tight"
              ...
              <div className="prose prose-lg max-w-none text-[#555555] prose-p:leading-[1.85] prose-headings:font-bold prose-headings:text-[#111111]">
                <p className="text-lg md:text-xl font-medium text-[#111111] leading-relaxed border-l-4 border-[var(--color-primary)] pl-6 mb-8 italic">
                  {post.excerpt}
                </p>
              ...
              <div className="bg-white border border-gray-100 shadow-[var(--shadow-premium)] p-8 sticky top-24">
                ...
                <div className="space-y-6">
                  {recentPosts.map(p => (
                    <div key={p.id} className="flex gap-4 group">
                      <div className="w-20 h-20 flex-shrink-0 overflow-hidden border border-gray-100 p-1 bg-gray-50 flex items-center justify-center">
                        {p.image ? (
                          <img 
                            src={p.image} 
                            alt={p.title} 
                            className="w-full h-full object-cover transform transition-transform duration-700 ease-out group-hover:scale-110 grayscale" 
                          />
                        ) : (
                          <div className="w-full h-full bg-[var(--color-primary)]/10 text-[var(--color-primary)] flex items-center justify-center font-bold text-xs">
                            BLOG
                          </div>
                        )}
                      </div>
                ...
                <div className="mt-10 bg-[#111111] p-8 text-center relative overflow-hidden">
                  ...
                  <p className="text-white/70 text-sm mb-6 leading-relaxed relative z-10">
                    Get your Black+Decker home and kitchen appliances running at peak performance with our certified technicians.
                  </p>
                  <Link 
                    to="/contact-us"
