...
export const blogData: Record<string, BlogPost> = {
  'hello-world': {
    ...
    content: 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing! In this blog, we share technical insights, product updates, troubleshooting guides, and best maintenance practices for all your appliances and tools. Our dedicated service center is committed to delivering reliable repair solutions, genuine spare parts, and expert after-sales support across the UAE.',
    date: 'January 16, 2024',
    author: 'Admin',
    image: '',
  },
  'how-to-be-ahead-of-stock-changes': {
    id: 'how-to-be-ahead-of-stock-changes',
    title: 'How to Be Ahead of Stock Changes',
    excerpt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. ...',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. In fast-paced industrial and domestic maintenance sectors, anticipating spare-parts demand and inventory turnover is paramount. By maintaining direct manufacturer relationships and keeping high-wear components readily available in our Dubai workshop, we eliminate unnecessary downtime and deliver swift, dependable repairs.',
    date: 'June 1, 2018',
    author: 'Admin',
  ...
  'online-reputation-and-management': {
    id: 'online-reputation-and-management',
    title: 'Online Reputation And Management',
    excerpt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. ...',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. Service excellence and transparent customer communication form the bedrock of enduring trust. From prompt diagnosis updates to clear warranty terms and genuine parts verification, every customer interaction contributes directly to an uncompromised service reputation.',
    date: 'June 1, 2018',
    author: 'Admin',
  ...
  'tips-to-move-your-project-more-forward': {
    id: 'tips-to-move-your-project-more-forward',
    title: 'Tips To Move Your Project More Forward',
    excerpt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. ...',
    content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie blandit lobortis. Curabitur feugiat laoreet odio, sit amet tincidunt sem bibendum et. Regular preventative check-ups, functional performance testing, and utilizing genuine replacement parts keep your equipment functioning at peak capability, preventing unexpected shutdowns and keeping your projects on track.',
    date: 'June 1, 2018',
    author: 'Admin',
